  ...
  L.Control.Search = L.Control.extend({
    ...
    _defaultFormatData: function (json) {
      ...
      if (L.Util.isArray(propLoc))
        for (i in json) jsonret[self._getPath(json[i], propName)] = L.latLng(json[i][propLoc[0]], json[i][propLoc[1]])
    ...
    _handleArrowSelect: function (velocity) {
      ...
      if (velocity == 1 && this._tooltip.currentSelection >= searchTips.length - 1) {
        ...
        if (
          tipOffsetTop + searchTips[this._tooltip.currentSelection].clientHeight >=
          this._tooltip.scrollTop + this._tooltip.clientHeight
        ) {
          this._tooltip.scrollTop =
            tipOffsetTop - this._tooltip.clientHeight + searchTips[this._tooltip.currentSelection].clientHeight
